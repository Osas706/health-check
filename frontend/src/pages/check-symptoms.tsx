...
function CheckSymptoms() {
  ...
  return (
    <div className="w-full bg-slate-100 flex flex-col justify-center gap-2 py-10 min-h-[calc(100vh-20rem)]">
      ...
      <div className="max-w-sm md:max-w-md mx-auto bg-white rounded-3xl border border-slate-300 p-5">
        {currentStep < 8 && (
            ...
            <div className="w-full space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      Is there anything else about your health you would like us
                      to know ?
                    </FormLabel>
                    <FormControl>
                      <Input
        ...
        <div className="flex items-start gap-1 text-red-400 mt-5">
          ...
          <p className="text-xs">
            ...
            emergency that requires immediate attention please call 911 or the
